    ...
    <main className="text-lg px-64 py-8">
      <div className="flex flex-col gap-5">
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          фреймворка для стилей <b>TailwindCSS</b>, а также UI-библиотеки{" "}
          <b>Ant Design</b>. Пагинация реализована с помощью{" "}
          <b>React Router V6</b>.
        </p>
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          выставленным критериям поиска. Картины можно искать как по названию,
          так и по различным фильтрам:
          <ul className="py-4">
            <li>По году;</li>
            <li>По странам;</li>
        ...
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          В приложении есть страница, на которой можно получить случайный фильм,
          исходя из выставленных значений фильтров.
          <ul className="py-4">
            <li>По жанру;</li>
          ...
          <b>ВАЖНО</b>: для того, чтобы воспользоваться случайным поиском,
          необходимо предварительно авторизоваться (авторизация состоит из ввода
          имени пользователя и пароля - кнопка для авторизации находится в
        ...
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          <ul>
            ...
            <li>
              Когда пользователь ищет картины по их названию, перед отправкой
              запроса к API срабатывает тайм-аут в 1 секунду (debounce);
            </li>
          </ul>
        </p>
      </div>
